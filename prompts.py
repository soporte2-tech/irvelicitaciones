...
**OUTPUT LANGUAGE:** Your entire final response, including all text generated by the prompts you create, MUST be in **Spanish (castellano)**. This is the most critical rule and overrides all others regarding language.
